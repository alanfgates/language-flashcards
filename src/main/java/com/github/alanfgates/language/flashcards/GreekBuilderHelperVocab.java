...
class GreekBuilderHelperVocab {
  static List<Word> getVocab() {
    return Arrays.asList(
        ...
        // 2801
        new Word("δε", "weak but/yet, and", true),
        // 2757
        new Word("ἐν", "in", true, DATIVE),
        // 2666
        ...
        new Word("λέγω", "I say - root *λεγ", true, PRESENT),
        new Word("ἐρῶ", "I will say - λέγω root *ερ", FUTURE),
        new Word("εἶπον", "I said - λέγω root *ιπ", true, SECOND_AORIST),
        ...
        // 1768
        new Word("εἰς", "into", true, ACCUSATIVE),
        // 1391
        ...
        // 1318
        new Word("Θεός", "God", true, MASCULINE),
        new Word("Θεοῦ", "God", MASCULINE, GENITIVE),
        // 1297
        // for ὅτι see ὅστις below
        // 1283
        new Word("πᾶς", "all every each", true, MASCULINE),
        new Word("πᾶσα", "all every each", FEMININE),
        new Word("πᾶν", "all every each", NEUTER),
        // 1042
        new Word("γάρ", "for, because", true),
        // 916
        new Word("ἐκ", "out of, from", true, GENITIVE),
        ...
        // 699
        new Word("πρός", "to, towards", true, ACCUSATIVE),
        // 669
        new Word("*γεν",	"to become, to be", ROOT),
        new Word("γίνομαι",	"I become, I am - root *γεν", true, PRESENT, DEPONENT),
        ...
        // 663
        new Word("ἵνα", "in order that", true),
        // 646
        new Word("ἀπό", "from", true, GENITIVE),
        // 638
        new Word("ἀλλά", "but (strong)", true),
        // 634
        new Word("*ερχ", "To come, to go", ROOT, PRESENT),
        new Word("*ελευθ", "to come/go ", ROOT, FUTURE, AORIST, PERFECT),
        new Word("ἔρχομαι", "I come, I go - root *ερχ", true, PRESENT, DEPONENT),
        new Word("ἐλεύσομαι", "I will come/go - ἔρχομαι root *ελευθ", FUTURE, DEPONENT),
        new Word("ἦλθον", "I came/went - ἔρχομαι root *ελευθ", true, SECOND_AORIST),
        ...
        new Word("ποιω", "I do, I make - root *ποιε", true, PRESENT),
        ...
        // 550
        new Word("ἄνθρωπος", "human being", true, MASCULINE),
    ...
    new Word("τινας")
        ...
        // 531
        new Word("Χριστός", "Christ", true, MASCULINE),
        ...
        new Word("ὁρω",	"I see - root *ορα", true, PRESENT),
        new Word("ὄψομαι",	"I will see - ὁρω root *οπ", FUTURE, DEPONENT),
        new Word("εἶδον",	"I saw - ὁρω root *ιδ", true, SECOND_AORIST),
        ...
        new Word("ἀκούω", "I hear - root *ακου", true, PRESENT),
        ...
        // 414
        new Word("πατήρ", "father", true, MASCULINE),
        new Word("πατρός", "father", MASCULINE, GENITIVE),
        // 389
        new Word("ἡμέρα", "day", true, FEMININE),
        new Word("ἡμέρας", "day", FEMININE, GENITIVE),
        // 379
        new Word("πνεῦμα", "spirit, wind, breath", true, NEUTER),
        new Word("πνεύματος", "spirit, wind, breath", NEUTER, GENITIVE),
        // 377
        new Word("υἱός", "son", true, MASCULINE),
        ...
        // 343
        new Word("ἀδελφός", "brother", true, MASCULINE),
        ...
        // 324
        new Word("οἶδα", "I know", true, PRESENT),
        // 319
        new Word("ἑαυτοῦ", true)
        ...
        new Word("λαλω", "I speak - root *λαλε", true, PRESENT),
        ...
        // 273
        new Word("οὐρανός", "heaven", true, MASCULINE),
        new Word("οὐρανοῦ", "heaven", MASCULINE, GENITIVE),
        // 261
        new Word("μαθητής", "student, disciple", true, MASCULINE),
        new Word("μαθητοῦ", "student, disciple", MASCULINE, GENITIVE),
        // 258
        new Word("*λαβ", "to take, to receive ", ROOT),
        new Word("λαμβάνω", "I take, I receive - root *λαβ", true, PRESENT),
        new Word("λήμψομαι", "I will take/receive - λαμβάνω root *λαβ", true, FUTURE, DEPONENT),
        new Word("ἔλαβον", "I took/received - λαμβάνω root *λαβ", true, SECOND_AORIST),
        new Word("εἴληφα", "I have taken/received - λαμβάνω root *λαβ", true, SECOND_PERFECT),
        ...
        // 250
        new Word("γῆ", "land, earth", true, FEMININE),
        new Word("γῆς", "land, earth", FEMININE, GENITIVE),
        // 249
        new Word("*πιστευ", "to believe ", ROOT),
        new Word("πιστεύω", "I believe - root *πιστευ", true, PRESENT),
        ...
        new Word("ὑπό", true)
            ...
            .addForm("by", GENITIVE),
        // 218
        new Word("ἐξέρχομαι", "I go out", true),
        ...
        // 216
        new Word("ἀνήρ", "man", true, MASCULINE),
        new Word("ἀνδρός", "man", MASCULINE, GENITIVE),
        // 215
        new Word("γυνή", "woman", true, FEMININE),
        new Word("γυναικός", "woman", FEMININE, GENITIVE),
        new Word("τέ", "and, so"),
        // 210
        new Word("*δυν", "to be able ", ROOT),
        new Word("δύναμαι", "I am able - root *δυν", true, PRESENT, DEPONENT),
        ...
        new Word("θέλω", "I want - root *εθελε", true, PRESENT),
        new Word("ἠθέλησα", "I wanted - θέλω root *εθελε", AORIST),
        new Word("ὅυτω", "thus", true),
        new Word("ὅυτως", "thus"),
        // 195
        new Word("Ἰοὐδαῖος", "jewish", true, ADJECTIVE, MASCULINE),
        ...
        new Word("εισερχομαι", "I enter", true, PRESENT),
        ...
        new Word("καλέω", "I call - root *καλεϝ", true, PRESENT),
        ...
        new Word("ἀγαπαω", "I love - root *ἀγαπα", true, PRESENT),
        ...
        new Word("νυν", "now", true),
        // 144
        new Word("προφητης", "prophet", true, MASCULINE),
        new Word("προφητου", "prophet", MASCULINE, GENITIVE),
        new Word("*εγερ", "to raise ", ROOT),
        new Word("ἐγείρω", "I raise - root *εγερ", true, PRESENT),
        ...
        // 143
        new Word("οὐδέ", "and not, neither", true),
        new Word("απο + *σε", "to let go, divorce, forgive ", ROOT),
        new Word("ἀφιημι", "I let go, divorce, forgive - root απο + *σε", true, PRESENT),
        new Word("ἀφήσω", "I will forgive - ἀφιημι root απο + *σε", FUTURE),
        new Word("ἀφῆκα", "I forgave - ἀφιημι root απο + *σε", true, AORIST),
        ...
        new Word("ἀποστέλλω", "I send - root απο + *στελ", true, PRESENT),
        ...
        // 129
        new Word("ἀμήν", "truly", true),
        // 128
        new Word("νεκρός", "dead", true, ADJECTIVE, MASCULINE),
        new Word("νεκρά", "dead", ADJECTIVE, FEMININE),
        new Word("νεκρόν", "dead", ADJECTIVE, NEUTER),
        new Word("συν", "with", true, DATIVE),
        // 124
        new Word("δοῦλος", "slave", true, MASCULINE),
        new Word("δοῦλου", "slave", MASCULINE, GENITIVE),
        // 123
        new Word("ὅταν", "whenever", true),
        // 122
        new Word("αἰών", "age", true, NOUN, MASCULINE),
        new Word("αἰῶνος", "age", NOUN, MASCULINE, GENITIVE),
        new Word("αἰώνος", "eternal", true, ADJECTIVE, MASCULINE, FEMININE),
        new Word("αἰώνον", "eternal", ADJECTIVE, NEUTER),
        new Word("ἀρχιερεύς", "high priest", true, MASCULINE),
        new Word("ἀρχιερέως", "high priest", MASCULINE, GENITIVE),
        new Word("*βαλ", "to throw ", ROOT),
        new Word("βάλλω", "I throw - root *βαλ", true, PRESENT),
        ...
        // 120
        new Word("θάνατος", "death", true, MASCULINE),
        new Word("θάνατου", "death", MASCULINE, GENITIVE),
        // 119
        new Word("δυναμις", "power, ability", true, FEMININE),
        new Word("δυναμεως", "power, ability", FEMININE, GENITIVE),
        new Word("παραδιδωμι", "I hand over", true, PRESENT),
        ...
        new Word("μένω", "I remain - root *μεν", true, PRESENT),
        ...
        // 117
        new Word("ἀπέρχομαι", "I depart, I go away", true, PRESENT),
        ...
        new Word("*ζητε", "to seek ", true, ROOT),
        ...
        new Word("ἀποθνῃσκω", "I die - root απο + *θαν", true, PRESENT),
        ...
        new Word("ἀνίστημι", "I raise, I stand up ", true, PRESENT),
        ...
        new Word("σῴζω", "I save - root *σωζ", true, PRESENT),
        ...
        new Word("δει", "it is necessary", true),
        new Word("ὁδος", "way, road", true, FEMININE),
        new Word("ὁδου", "way, road", FEMININE, GENITIVE),
        // 100
        new Word("ἀλληλων", "each other", true),
        new Word("καλος", "good", true, ADJECTIVE, MASCULINE),
        new Word("καλη", "good", ADJECTIVE, FEMININE),
        new Word("καλον", "good", ADJECTIVE, NEUTER),
        new Word("ὀφθαλμος", "eye, sight", true, MASCULINE),
        new Word("ὀφθαλμου", "eye, sight", MASCULINE, GENITIVE),
        new Word("*θε", "to put, place ", ROOT),
        new Word("τίθημι", "I put, I place - root *θε", true, PRESENT),
        new Word("θήσω", "I will put - τίθημι root *θε", FUTURE),
        new Word("ἔθηκα", "I placed - τίθημι root *θε", true, AORIST),
        ...
        new Word("γεννῶ", "I beget - root *γεννα", true, PRESENT),
        ...
        new Word("περιπατω", "I walk around - root περι + *πατε", true, PRESENT),
        ...
        new Word("ἀπόλλυμι", "I destroy, middle I perish, I die - root απο + *ὀλ", true, PRESENT),
        new Word("ἀπολέσω", "I will destroy - ἀπόλλυμι root απο + *ὀλ", FUTURE),
        new Word("ἀπώλεσα", "I destroyed - ἀπόλλυμι root απο + *ὀλ", true, AORIST),
        ...
        new Word("μηδείς", "no, no one", true),
        // 88
        new Word("ἑπτά", "seven, doesn't decline", true),
        // 87
        new Word("οὔτε", "neither", true),
        // 86
        new Word("*αρχ", "(middle) to begin (active) to rule, rare ", ROOT),
        new Word("ἄρχομαι", "I begin (active I rule, but rare) - root *αρχ", true, MIDDLE, PRESENT),
        new Word("ἄρξομαι", "I will begin - ἄρχομαι root *αρχ", FUTURE, MIDDLE),
        new Word("ἠρξάμην", "I began - ἄρχομαι root *αρχ", true, AORIST, MIDDLE),
        new Word("*πληρο", "to fill, fulfill ", ROOT),
        new Word("πληρω", "I fill, fulfill - root *πληρο", true, PRESENT),
        ...
        // 83
        new Word("μήτηρ", "mother", true, FEMININE),
        ...
        new Word("ἀναβαίνω", "I go up, rise up, advance - root ανα + *βα", true, PRESENT),
        ...
        new Word("ἕκαστος", "each, every", true, ADJECTIVE, MASCULINE),
        ...
        // 81
        new Word("ἐκβάλλω", "I cast out", true),
        ...
        new Word("καταβαίνω", "I come/go down ", true),
        ...
        new Word("μᾶλλον", "more, rather", true),
        // 80
        new Word("άποστολος", "apostle", true, MASCULINE),
        ...
        new Word("ὑπάγω", "I go away, I draw off - root ὑπο + *αγ", true, PRESENT),
        new Word("ὑπάξω", "I will go away, I will draw off - ὑπάγω root ὑπο + *αγ", FUTURE),
        new Word("ὑπἠγαγον", "I went away, I drew off - ὑπάγω root ὑπο + *αγ", true, SECOND_AORIST),
        ...
        new Word("δίκαιος", "upright, just, righteous", true, ADJECTIVE, MASCULINE),
        new Word("δικαία", "upright, just, righteous", ADJECTIVE, FEMININE),
        new Word("δικαιον", "upright, just, righteous", ADJECTIVE, NEUTER),
        // 78
        new Word("στόµα", "mouth", true, NEUTER),
        new Word("στόματος", "mouth", NEUTER, GENITIVE),
        new Word("πονηρός", "physical: sick, bad spiritual: evil, wicked", true, ADJECTIVE, MASCULINE),
        ...
        // 77
        new Word("σηµεῖον", "sign, miracle", true, NEUTER),
        new Word("σηµεῖου", "sign, miracle", NEUTER, GENITIVE),
        new Word("ανα + *οιγω", "to open, unlock, disclose ", ROOT),
        new Word("ἀνοίγω", "I open, unlock, disclose - root ανα + *οιγω", true, PRESENT),
        new Word("ἀνέῳζα", "I opened, unlocked, disclosed - ἀνοίγω root ανα + *οιγω", true, AORIST),
        ...
        new Word("βαπτίζω", "I baptize, wash, dip - root *βαπτιδ", true, PRESENT),
        ...
        // 76
        new Word("εὐαγγέλιον", "good news, gospel", true, NEUTER),
        new Word("εὐαγγέλιου", "good news, gospel", NEUTER, GENITIVE),
        new Word("πρόσωπον", "face, countenance", true, NEUTER),
        new Word("πρόσωπου", "face, countenance", NEUTER, GENITIVE),
        new Word("ὕδωρ", "water", true, NEUTER),
        new Word("ὕδατος", "water", NEUTER, GENITIVE),
        new Word("*μαρτυρε", "to bear witness ", ROOT),
        new Word("μαρτυρῶ", "I bear witness - root *μαρτυρε", true, PRESENT),
        ...
        // 75
        new Word("κεφαλή", "head", true, FEMININE),
        new Word("κεφαλῆς", "head", FEMININE, GENITIVE),
        new Word("δώδεκα", "twelve", true),
        // 74
        new Word("απο + *κτεν", "to kill ", ROOT),
        new Word("ἀποκτείνω", "I kill - root απο + *κτεν", true, PRESENT),
        ...
        // 73
        new Word("φῶς", "light", true, NEUTER),
        new Word("φωτός", "light", NEUTER, GENITIVE),
        new Word("*πι", "to drink ", ROOT),
        new Word("πίνω", "I drink - root *πι", true, PRESENT),
        ...
        // 71
        new Word("ἱερόν", "temple", true, NEUTER),
        new Word("ἱεροῦ", "temple", NEUTER, GENITIVE),
        new Word("πῦρ", "fire", true, NEUTER),
        ...
        new Word("ᾔτησα", "I asked - αἰτέω root *αἰτε", true, AORIST),
        ...
        new Word("τηρέω", "I keep, I guard - root *τηρε", true, PRESENT),
        ...
        // 69
        new Word("τρεῖς", "three", true, MASCULINE, FEMININE),
        new Word("τρία", "three", NEUTER),
        // 68
        new Word("ῥῆμα", "word, thing", true, NEUTER),
        new Word("ῥῆματος", "word, thing", NEUTER, GENITIVE),
        new Word("σάββατον", "Sabbath, week", true, NEUTER),
        new Word("σάββατου", "Sabbath, week", NEUTER, GENITIVE),
        // 67
        new Word("ἐντολή", "commandment", true, FEMININE),
        new Word("ἐντολῆς", "commandment", FEMININE, GENITIVE),
        new Word("πλοῖον", "ship, boat", true, NEUTER),
        new Word("πλοῖου", "ship, boat", NEUTER, GENITIVE),
        // 66
        new Word("πρεσβύτερος", true)
        ...
        new Word("ἤνεγκα", "I carried, bore, produced - φέρω  root ?", true, AORIST),
        ...
        new Word("ἀπολύω", "I release - root απο + *λυ", true, PRESENT),
        ...
        new Word("καρπός", "fruit, crop, result", true, MASCULINE),
        ...
        new Word("γραμματεύς", "scribe", true, MASCULINE),
        new Word("γραμματέως", "scribe", MASCULINE, GENITIVE),
        new Word("δαιμόνιον", "demon", true, NEUTER),
        ...
        // 62
        new Word("Ἱεροσόλυμα", "Jerusalem", true, NEUTER),
        ...
        new Word("θέλημα", "will, desire", true, NEUTER),
        new Word("θέληματος", "will, desire", NEUTER, GENITIVE),
        new Word("θρόνος", "throne", true, MASCULINE),
        new Word("θρόνου", "throne", MASCULINE, GENITIVE),
        // 61
        new Word("*δοξαδ", "to praise, honor, glorify ", ROOT),
        new Word("δοξάζω", "I praise, honor, glorify - root *δοξαδ", true, PRESENT),
        ...
        new Word("κηρύσσω", "I proclaim, preach - root *κηρυγ", true, PRESENT),
        ...
        new Word("εὐαγγελίζω", "I bring good news , often occurs in middle voice with same meaning - root εὐ + *αγγελιδ", true, PRESENT),
        ...
        new Word("ὑπάρχω", "I am, I exist - root ὑπό + *αρχ", true, PRESENT),
        ...
        // 60
        new Word("ἱμάτιον", "garment", true, NEUTER),
        ...
        new Word("διδάσκαλος", "teacher", true, MASCULINE),
        new Word("διδάσκαλου", "teacher", MASCULINE, GENITIVE),
        new Word("χαρά", "joy", true, FEMININE),
        new Word("χαρᾶς", "joy", FEMININE, GENITIVE),
        new Word("συνάγω", "I bring together, I compile ", true, PRESENT),
        ...
        new Word("δέχομαι", "I take, receive ", true, DEPONENT),
        ...
        new Word("συναγωγή", "synagogue, meeting", true, FEMININE),
        ...
        new Word("παιδίον", "child, infant", true, NEUTER),
        ...
        // 51
        new Word("σοφία", "skill, wisdom", true, FEMININE),
        new Word("σοφίας", "skill, wisdom", FEMININE, GENITIVE),
        new Word("εὐθύς", "immediately", true),
        // 50
        new Word("γλῶσσα", "tongue, language", true, FEMININE),
        new Word("γλῶσσης", "tongue, language", FEMININE, GENITIVE),
        new Word("γραφή", "scripture, writing", true, FEMININE),
        new Word("γραφῆς", "scripture, writing", FEMININE, GENITIVE),
        new Word("παραβολή", "parable", true, FEMININE),
        new Word("παραβολῆς", "parable", FEMININE, GENITIVE),
        new Word("ἔσχατος", "last", true, ADJECTIVE, MASCULINE),
        new Word("ἔσχατη", "last", ADJECTIVE, FEMININE),
        new Word("ἔσχατον", "last", ADJECTIVE, NEUTER),
        new Word("κακός", "bad, evil", true, ADJECTIVE, MASCULINE),
        new Word("κακή", "bad, evil", ADJECTIVE, FEMININE),
        new Word("κακόν", "bad, evil", ADJECTIVE, NEUTER),
        new Word("μακάριος", "blessed, happy", true, ADJECTIVE, MASCULINE),
        ...
        // 48
        new Word("ἔρημος", "isolated, desolate, deserted, used as substantive, desert (feminine in this case)", true, ADJECTIVE),
        ...
        new Word("φόβος", "fear, fear inspiring thing, reverence", true, MASCULINE),
        new Word("φόβου", "fear, fear inspiring thing, reverence", MASCULINE, GENITIVE),
        new Word("φυλακή", "guard, prison, watch (of the night)", true, FEMININE),
        ...
        new Word("προσφέρω", "I bring, I offer - root προσ + φερω", true, PRESENT),
        new Word("προσήνεγκα", "I brought, I offered - προσφερω root προσ + φερω", true, AORIST),
        ...
        new Word("οὐκέτι", "no longer", true),
        // 46
        ...
        new Word("μικρός", "small, little", true, ADJECTIVE, MASCULINE),
        new Word("μικρά", "small, little", ADJECTIVE, FEMININE),
        new Word("μικρόν", "small, little", ADJECTIVE, NEUTER),
        // 45
        new Word("θλῖψις", "trouble that inflicts distress, oppression, affliction, tribulation", true, FEMININE),
        new Word("θλῖψεως", "trouble that inflicts distress, oppression, affliction, tribulation", FEMININE, GENITIVE),
        new Word("ναός", "temple, deity's palace", true, MASCULINE),
        ...
        // 44
        new Word("ἐπιγινώσκω", "I understand, recognize", true, PRESENT),
        ...
        new Word("κατοικῶ", "I dwell, settle, inhabit - κατοικέω", true, PRESENT),
        new Word("κατῷκησα", "I dwelt, settled, inhabited - κατοικέω", AORIST),
        // 43
        new Word("σπέρμα", "seed, descendant", true, NEUTER),
        new Word("σπέρματος", "seed, descendant", NEUTER, GENITIVE),
        new Word("σεαυτοῦ", "yourself", true, SINGULAR),
        new Word("ἁμαρτάνω", "I sin - root ἁμαρτ ?", true, PRESENT),
        ...
        new Word("δέω", "I tie, bind - root δε ?", true, PRESENT),
        ...
        new Word("διέρχομαι", "I pass through - δια ερχομαι", true, PRESENT, DEPONENT),
        ...
        new Word("θαυμάζω", "I marvel - root θαυμαστ ?", true, PRESENT),
        ...
        new Word("θεραπεύω", "I serve (a divinity), heal - root θεραπευ ?", true, PRESENT),
        ...
        new Word("φωνῶ", "I call, cry out - root φωνε ?", true, PRESENT),
