...
class GreekBuilderHelperVocab {
  static List<Word> getVocab() {
    return Arrays.asList(
        ...
        // 2757
        new Word("ἐν", "in", DATIVE).setRepeatable(true),
        // 2666
        ...
        new Word("λέγω", "I say - root *λεγ", PRESENT).setRepeatable(true),
        new Word("ἐρῶ", "I will say - λέγω root *ερ", FUTURE).setRepeatable(true),
        new Word("εἶπον", "I said - λέγω root *ιπ", SECOND_AORIST).setRepeatable(true),
        ...
        // 1768
        new Word("εἰς", "into ", ACCUSATIVE).setRepeatable(true),
        // 1391
        new Word("οὗτος", "this", MASCULINE).setRepeatable(true),
        new Word("αὕτη", "this", FEMININE).setRepeatable(true),
        new Word("τοῦτο", "this", NEUTER).setRepeatable(true),
        // 1365
        ...
        // 1318
        new Word("Θεός", "God", MASCULINE).setRepeatable(true),
        new Word("Θεοῦ", "God", MASCULINE, GENITIVE),
        // 1297
        // for ὅτι see ὅστις below
        // 1283
        new Word("πᾶς", "all every each", MASCULINE).setRepeatable(true),
        new Word("πᾶσα", "all every each", FEMININE),
        new Word("πᾶν", "all every each", NEUTER),
        // 1042
        new Word("γάρ", "for, because").setRepeatable(true),
        // 916
        new Word("ἐκ", "out of, from", GENITIVE).setRepeatable(true),
        new Word("ἐξ", "out of, from", GENITIVE),
        // 891
        new Word("ἐπί").setRepeatable(true)
          .addForm("onto", ACCUSATIVE)
          .addForm("over", GENITIVE)
          .addForm("at", DATIVE),
        // 719
        new Word("κύριος", "lord", MASCULINE).setRepeatable(true),
        new Word("κύριου", "lord", MASCULINE, GENITIVE),
        // 708
        // TODO add subjunctive, because it's pretty different
        new Word("*σεχ",	"to have", ROOT),
        new Word("ἔχω",	"I have - root *σεχ", PRESENT).setRepeatable(true),
        ...
        // 699
        new Word("πρός", "to, towards", ACCUSATIVE).setRepeatable(true),
        // 669
        new Word("*γεν",	"to become, to be", ROOT),
        new Word("γίνομαι",	"I become, I am - root *γεν", PRESENT, DEPONENT).setRepeatable(true),
        ...
        // 668
        new Word("διά").setRepeatable(true)
            .addForm("on account of", ACCUSATIVE)
            .addForm("through", GENITIVE),
        // 663
        new Word("ἵνα", "in order that").setRepeatable(true),
        // 646
        new Word("ἀπό", "from", GENITIVE).setRepeatable(true),
        // 638
        new Word("ἀλλά", "but (strong)").setRepeatable(true),
        // 634
        new Word("*ερχ", "To come, to go", ROOT, PRESENT),
        new Word("*ελευθ", "to come/go ", ROOT, FUTURE, AORIST, PERFECT),
        new Word("ἔρχομαι", "I come, I go - root *ερχ", PRESENT, DEPONENT).setRepeatable(true),
        ...
        new Word("ποιω", "I do, I make - root *ποιε", PRESENT).setRepeatable(true),
        ...
        // 550
        new Word("ἄνθρωπος", "human being", MASCULINE).setRepeatable(true),
    ...
    new Word("τινας")
        ...
        // 504
        new Word("ὡς", "as, like, when, that, how, approximately").setRepeatable(true),
        // 502
        new Word("εἰ", "if").setRepeatable(true),
        // 499
        new Word("οὖν", "therefore").setRepeatable(true),
        // 476
        new Word("κατά").setRepeatable(true)
            .addForm("according to", ACCUSATIVE)
            .addForm("down from", GENITIVE),
        // 473
        new Word("μετά").setRepeatable(true)
        ...
        new Word("ὁρω",	"I see - root *ορα", PRESENT).setRepeatable(true),
        ...
        new Word("ἀκούω", "I hear - root *ακου", PRESENT).setRepeatable(true),
        ...
        // 418
        new Word("πολύς", "many, much", MASCULINE).setRepeatable(true),
        new Word("πολλή", "many, much", FEMININE),
        new Word("πολύ", "many, much", NEUTER),
        // 417
        new Word("*δο", "to give ", ROOT),
        new Word("δίδωμι", "I give - root *δο", PRESENT).setRepeatable(true),
        ...
        // 414
        new Word("πατήρ", "father", MASCULINE).setRepeatable(true),
        new Word("πατρός", "father", MASCULINE, GENITIVE),
        // 389
        new Word("ἡμέρα", "day", FEMININE).setRepeatable(true),
        new Word("ἡμέρας", "day", FEMININE, GENITIVE),
        // 379
        new Word("πνεῦμα", "spirit, wind, breath", NEUTER).setRepeatable(true),
        new Word("πνεύματος", "spirit, wind, breath", NEUTER, GENITIVE),
        // 377
        new Word("υἱός", "son", MASCULINE).setRepeatable(true),
        new Word("υἱοῦ", "son", MASCULINE, GENITIVE),
        // 353
        new Word("εἷς", "one", MASCULINE).setRepeatable(true),
        new Word("μία", "one", FEMININE),
        new Word("ἕν", "one", NEUTER),
        // 343
        new Word("ἀδελφός", "brother", MASCULINE).setRepeatable(true),
        new Word("ἀδελφοῦ", "brother", MASCULINE, GENITIVE),
        new Word("ἤ", "or").setRepeatable(true),
        // 333
        new Word("ἐάν", "if").setRepeatable(true),
        new Word("περί").setRepeatable(true)
            .addForm("around", ACCUSATIVE)
            .addForm("concerning, about", GENITIVE),
        // 324
        new Word("οἶδα", "I know", PRESENT).setRepeatable(true),
        // 319
        new Word("ἑαυτοῦ").setRepeatable(true)
        ...
        new Word("λαλω", "I speak - root *λαλε", PRESENT).setRepeatable(true),
        ...
        // 273
        new Word("οὐρανός", "heaven", MASCULINE).setRepeatable(true),
        new Word("οὐρανοῦ", "heaven", MASCULINE, GENITIVE),
        // 261
        new Word("μαθητής", "student, disciple", MASCULINE).setRepeatable(true),
        new Word("μαθητοῦ", "student, disciple", MASCULINE, GENITIVE),
        // 258
        new Word("*λαβ", "to take, to receive ", ROOT),
        new Word("λαμβάνω", "I take, I receive - root *λαβ", PRESENT).setRepeatable(true),
        ...
        // 250
        new Word("γῆ", "land, earth", FEMININE).setRepeatable(true),
        new Word("γῆς", "land, earth", FEMININE, GENITIVE),
        // 249
        new Word("*πιστευ", "to believe ", ROOT),
        new Word("πιστεύω", "I believe - root *πιστευ", PRESENT).setRepeatable(true),
        ...
        // 245
        new Word("μέγας", "large, great", MASCULINE).setRepeatable(true),
        new Word("μεγάλη", "large, great", FEMININE),
        new Word("μέγα", "large, great", NEUTER),
        // 243
        new Word("πίστις", "faith, trust", FEMININE).setRepeatable(true),
        new Word("πίστεως", "faith, trust", FEMININE, GENITIVE),
        // 242
        new Word("*γνω", "to know ", ROOT),
        new Word("γινώσκω", "I know - root *γνω", PRESENT).setRepeatable(true),
        ...
        // 234
        new Word("ὄνομα", "name", MASCULINE).setRepeatable(true),
        new Word("ὄνοματος", "name", MASCULINE, GENITIVE),
        // 233
        new Word("ἅγιος", "holy", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἅγια", "holy", ADJECTIVE, FEMININE),
        new Word("ἅγιον", "holy", ADJECTIVE, NEUTER),
        // 231
        new Word("απο + *κριν", "to answer ", ROOT),
        new Word("ἀποκρίνομαι", "I answer - root απο + *κριν", PRESENT, DEPONENT).setRepeatable(true),
        ...
        // 220
        new Word("ὑπό").setRepeatable(true)
        ...
        // 216
        new Word("ἀνήρ", "man", MASCULINE).setRepeatable(true),
        new Word("ἀνδρός", "man", MASCULINE, GENITIVE),
        // 215
        new Word("γυνή", "woman", FEMININE).setRepeatable(true),
        new Word("γυναικός", "woman", FEMININE, GENITIVE),
        new Word("τέ", "and, so"),
        // 210
        new Word("*δυν", "to be able ", ROOT),
        new Word("δύναμαι", "I am able - root *δυν", PRESENT, DEPONENT).setRepeatable(true),
        ...
        new Word("θέλω", "I want - root *εθελε", PRESENT).setRepeatable(true),
        new Word("ἠθέλησα", "I wanted - θέλω root *εθελε", AORIST),
        new Word("ὅυτω", "thus"),
        new Word("ὅυτως", "thus").setRepeatable(true),
        // 195
        new Word("Ἰοὐδαῖος", "jewish", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("Ἰοὐδαῖα", "jewish", ADJECTIVE, FEMININE),
        new Word("Ἰοὐδαῖον", "jewish", ADJECTIVE, NEUTER),
        // 194
        new Word("παρά").setRepeatable(true)
        ...
        new Word("γραφω", "I write - root *γραφ", PRESENT).setRepeatable(true),
        ...
        // 186
        new Word("κόσμος", "world", MASCULINE).setRepeatable(true),
        new Word("κόσμου", "world", MASCULINE, GENITIVE),
        // 182
        new Word("καθώς", "just as").setRepeatable(true),
        // 179
        new Word("μέν", "indeed, on the one hand").setRepeatable(true),
        // 177
        new Word("χείρ", "hand", FEMININE).setRepeatable(true),
        new Word("χειρός", "hand", FEMININE, GENITIVE),
        // 176
        new Word("*ευρ", "to find ", ROOT),
        new Word("ἑυρίσκω", "I find - root *ευρ", PRESENT).setRepeatable(true),
        ...
        // 175
        new Word("ἄγγελος", "messenger, angel", MASCULINE).setRepeatable(true),
        new Word("ἄγγελου", "messenger, angel", MASCULINE, GENITIVE),
        new Word("ὄχλος", "crowd", MASCULINE).setRepeatable(true),
        new Word("ὄχλου", "crowd", MASCULINE, GENITIVE),
        // 173
        new Word("ἁμαρτία", "sin", FEMININE).setRepeatable(true),
        ...
        // 166
        new Word("δόξα", "glory", FEMININE).setRepeatable(true),
        new Word("δόξης", "glory", FEMININE, GENITIVE),
        new Word("ἄν", "if, would, might").setRepeatable(true),
        // 163
        new Word("πόλις", "city", FEMININE).setRepeatable(true),
        new Word("πόλεως", "city", FEMININE, GENITIVE),
        // 162
        new Word("βασιλεία", "kingdom", FEMININE).setRepeatable(true),
        new Word("βασιλευς", "king", MASCULINE).setRepeatable(true), // 115
        new Word("βασιλεως", "king", MASCULINE, GENITIVE),
        new Word("βασιλείας", "kingdom", FEMININE, GENITIVE),
        new Word("ἔθνος", "people", NEUTER).setRepeatable(true),
        new Word("ἔθνους", "people", NEUTER, GENITIVE),
        // 160
        new Word("τοτε", "then").setRepeatable(true),
        new Word("ἕως", "until").setRepeatable(true),
        // ?
        new Word("ὅστις", "whoever, everyone (ὅς + τις both parts decline)", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἥτις", "whoever, everyone (ἥ + τις both parts decline)", ADJECTIVE, FEMININE),
        new Word("ὅτι").setRepeatable(true)
            .addForm("whoever, everyone (ὅ + τις both parts decline)", ADJECTIVE, NEUTER)
            .addForm("that, because"),
        // 159
        new Word("πρῶτος", "first", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("πρῶτη", "first", ADJECTIVE, FEMININE),
        new Word("πρῶτον", "first", ADJECTIVE, NEUTER),
        // 157
        new Word("καρδια", "heart", FEMININE).setRepeatable(true),
        new Word("καρδιας", "heart", FEMININE, GENITIVE),
        new Word("*εσθι", "to eat ", ROOT),
        new Word("ἐσθιω", "I eat - root *εσθι", PRESENT).setRepeatable(true),
        ...
        new Word("ἵστημι", "Transitive: I set, put, place Intransitive: I stand, I appear, I stop - root *στα", PRESENT).setRepeatable(true),
        ...
        new Word("ἀλλος", "other", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἀλλη", "other", ADJECTIVE, FEMININE),
        new Word("ἀλλο", "other", ADJECTIVE, NEUTER),
        new Word("χαρις", "grace", FEMININE).setRepeatable(true),
        new Word("χαριτος", "grace", FEMININE, GENITIVE),
        // 153
        new Word("*πορευ", "to go, to live ", ROOT),
        new Word("πορεύομαι", "I go, I live - root *πορευ", PRESENT, DEPONENT).setRepeatable(true),
        ...
        // 150
        new Word("ὑπερ").setRepeatable(true)
            .addForm("above", ACCUSATIVE)
            .addForm("in behalf of", GENITIVE),
        // 148
        new Word("*καλεϝ", "to call ", ROOT),
        new Word("καλέω", "I call - root *καλεϝ", PRESENT).setRepeatable(true),
        ...
        new Word("ἀγαπαω", "I love - root *ἀγαπα", PRESENT).setRepeatable(true),
        ...
        new Word("νυν", "now").setRepeatable(true),
        // 144
        new Word("προφητης", "prophet", MASCULINE).setRepeatable(true),
        new Word("προφητου", "prophet", MASCULINE, GENITIVE),
        new Word("*εγερ", "to raise ", ROOT),
        new Word("ἐγείρω", "I raise - root *εγερ", PRESENT).setRepeatable(true),
        ...
        // 143
        new Word("οὐδέ", "and not, neither").setRepeatable(true),
        new Word("απο + *σε", "to let go, divorce, forgive ", ROOT),
        new Word("ἀφιημι", "I let go, divorce, forgive - root απο + *σε", PRESENT).setRepeatable(true),
        ...
        // 142
        new Word("λαος", "people", MASCULINE).setRepeatable(true),
        new Word("λαου", "people", MASCULINE, GENITIVE),
        new Word("σωμα", "body", NEUTER).setRepeatable(true),
        new Word("σωματος", "body", NEUTER, GENITIVE),
        // 141
        new Word("παλιν", "again").setRepeatable(true),
        // 140
        new Word("*ζα", "to live ", ROOT),
        new Word("ζάω", "I live - root *ζα", PRESENT).setRepeatable(true),
        new Word("ζἠσω", "I will live - ζάω root *ζα", FUTURE),
        new Word("ἔζεσα", "I lived - ζάω root *ζα", AORIST),
        // 139
        new Word("φωνή", "sound, voice", FEMININE).setRepeatable(true),
        new Word("φωνῆς", "sound, voice", FEMININE, GENITIVE),
        new Word("ζωή", "life", FEMININE).setRepeatable(true),
        new Word("ζωῆς", "life", FEMININE, GENITIVE),
        // 135
        new Word("δύο", "two").setRepeatable(true),
        // 133
        new Word("*βλεπ", "to see ", ROOT),
        new Word("βλέπω", "I see - root *βλεπ", PRESENT).setRepeatable(true),
        ...
        new Word("ἀποστέλλω", "I send - root απο + *στελ", PRESENT).setRepeatable(true),
        ...
        // 129
        new Word("ἀμήν", "truly").setRepeatable(true),
        // 128
        new Word("νεκρός", "dead", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("νεκρά", "dead", ADJECTIVE, FEMININE),
        new Word("νεκρόν", "dead", ADJECTIVE, NEUTER),
        new Word("συν", "with", DATIVE).setRepeatable(true),
        // 124
        new Word("δοῦλος", "slave", MASCULINE).setRepeatable(true),
        new Word("δοῦλου", "slave", MASCULINE, GENITIVE),
        // 123
        new Word("ὅταν", "whenever").setRepeatable(true),
        // 122
        new Word("αἰών", "age", NOUN, MASCULINE).setRepeatable(true),
        ...
        new Word("ἀρχιερεύς", "high priest", MASCULINE).setRepeatable(true),
        new Word("ἀρχιερέως", "high priest", MASCULINE, GENITIVE),
        new Word("*βαλ", "to throw ", ROOT),
        new Word("βάλλω", "I throw - root *βαλ", PRESENT).setRepeatable(true),
        ...
        // 120
        new Word("θάνατος", "death", MASCULINE).setRepeatable(true),
        new Word("θάνατου", "death", MASCULINE, GENITIVE),
        // 119
        new Word("δυναμις", "power, ability", FEMININE).setRepeatable(true),
        new Word("δυναμεως", "power, ability", FEMININE, GENITIVE),
        new Word("παραδιδωμι", "I hand over", PRESENT).setRepeatable(true),
        ...
        new Word("μένω", "I remain - root *μεν", PRESENT).setRepeatable(true),
        ...
        new Word("ζητῶ", "I seek - root *ζητε", PRESENT).setRepeatable(true),
        ...
        // 116
        new Word("ἀγαπη", "love", FEMININE).setRepeatable(true),
        ...
        // 114
        new Word("ἐκκλησια", "assembly, church", FEMININE).setRepeatable(true),
        new Word("ἐκκλησιας", "assembly, church", FEMININE, GENITIVE),
        new Word("ὀικος", "house", MASCULINE).setRepeatable(true),
        new Word("ὀικου", "house", MASCULINE, GENITIVE),
        new Word("οἰκία", "house, family", FEMININE).setRepeatable(true),
        new Word("οἰκὶας", "house, family", FEMININE, GENITIVE),
        new Word("ἴδιος", "one's own", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἰδία", "one's own", ADJECTIVE, FEMININE),
        new Word("ἴδιον", "one's own", ADJECTIVE, NEUTER),
        new Word("μόνος", "alone", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("μόνη", "alone", ADJECTIVE, FEMININE),
        new Word("μόνον", "alone", ADJECTIVE, NEUTER),
        new Word("*κριν", "to judge ", ROOT),
        new Word("κρίνω", "I judge - root *κριν", PRESENT).setRepeatable(true),
        ...
        new Word("ἀποθνῃσκω", "I die - root απο + *θαν", PRESENT).setRepeatable(true),
        ...
        new Word("ἀνίστημι", "I raise, I stand up ", PRESENT).setRepeatable(true),
        ...
        new Word("σῴζω", "I save - root *σωζ", PRESENT).setRepeatable(true),
        ...
        new Word("ὤρα", "hour", FEMININE).setRepeatable(true),
        new Word("ὤρας", "hour", FEMININE, GENITIVE),
        // 105
        new Word("ἐκει", "there").setRepeatable(true),
        // 103
        new Word("ὁτε", "when").setRepeatable(true),
        new Word("πως", "how").setRepeatable(true),
        new Word("ψυχη", "soul, life", FEMININE).setRepeatable(true),
        new Word("ψυχης", "soul, life", FEMININE, GENITIVE),
        // 102
        new Word("ἀγαθός", "good", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἀγαθή", "good", ADJECTIVE, FEMININE),
        new Word("ἀγαθόν", "good", ADJECTIVE, NEUTER),
        new Word("ἐξουσια", "authority", FEMININE).setRepeatable(true),
        new Word("ἐξουσιας", "authority", FEMININE, GENITIVE),
        // 101
        new Word("*αρ", "to take up, to take away ", ROOT),
        new Word("αἴρω", "I take up, I take away - root *αρ", PRESENT).setRepeatable(true),
        ...
        new Word("δει", "it is necessary").setRepeatable(true),
        new Word("ὁδος", "way, road", FEMININE).setRepeatable(true),
        new Word("ὁδου", "way, road", FEMININE, GENITIVE),
        // 100
        new Word("ἀλληλων", "each other").setRepeatable(true),
        new Word("καλος", "good", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("καλη", "good", ADJECTIVE, FEMININE),
        new Word("καλον", "good", ADJECTIVE, NEUTER),
        new Word("ὀφθαλμος", "eye, sight", MASCULINE).setRepeatable(true),
        new Word("ὀφθαλμου", "eye, sight", MASCULINE, GENITIVE),
        new Word("*θε", "to put, place ", ROOT),
        new Word("τίθημι", "I put, I place - root *θε", PRESENT).setRepeatable(true),
        ...
        // 98
        new Word("φαρισαιος", "Pharisee", MASCULINE).setRepeatable(true),
        new Word("φαρισαιου", "Pharisee", MASCULINE, GENITIVE),
        new Word("ἑτερος", "other, another", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἑτερα", "other, another", ADJECTIVE, FEMININE),
        new Word("ἑτερον", "other, another", ADJECTIVE, NEUTER),
        // 97
        new Word("ἀρτος", "bread", MASCULINE).setRepeatable(true),
        new Word("ἀρτου", "bread", MASCULINE, GENITIVE),
        new Word("αἱμα", "blood", NEUTER).setRepeatable(true),
        new Word("αἱματος", "blood", NEUTER, GENITIVE),
        new Word("*δακ", "to teach ", ROOT),
        new Word("διδασκω", "I teach - root *δακ", PRESENT).setRepeatable(true),
        ...
        new Word("γεννῶ", "I beget - root *γεννα", PRESENT).setRepeatable(true),
        ...
        new Word("περιπατω", "I walk around - root περι + *πατε", PRESENT).setRepeatable(true),
        ...
        new Word("φοβέομαι", "I fear - root *φοβε", PRESENT, DEPONENT).setRepeatable(true),
        new Word("ἐφοβήθην", "I feared - φοβέομαι root *φοβε", PASSIVE, AORIST, DEPONENT),
        // 93
        new Word("ἔτι", "still, yet").setRepeatable(true),
        new Word("πούς", "foot", MASCULINE).setRepeatable(true),
        new Word("ποδός", "foot", MASCULINE, GENITIVE),
        // 92
        new Word("δικαιοσύνη", "justice, righteousness", FEMININE).setRepeatable(true),
        new Word("δικαιοσύνης", "justice, righteousness", FEMININE, GENITIVE),
        new Word("εἰρήνη", "peace", FEMININE).setRepeatable(true),
        new Word("εἰρήνης", "peace", FEMININE, GENITIVE),
        // 91
        new Word("θάλασσα", "sea, lake", FEMININE).setRepeatable(true),
        new Word("θάλασσης", "sea, lake", FEMININE, GENITIVE),
        new Word("τόπος", "place, position; opportunity; passage", MASCULINE).setRepeatable(true),
        new Word("τόπου", "place, position; opportunity; passage", MASCULINE, GENITIVE),
        new Word("κατα + *εμ", "to sit down ", ROOT),
        new Word("κάθημαι", "I sit down ").setRepeatable(true),
        new Word("κάθησομαι", "I will sit down ", FUTURE),
        // 90
        new Word("*ἀκολουθε", "to follow ", ROOT),
        new Word("ἀκολουθω", "I follow - root *ἀκολουθε", PRESENT).setRepeatable(true),
        ...
        new Word("ἀπόλλυμι", "I destroy, middle I perish, I die - root απο + *ὀλ", PRESENT).setRepeatable(true),
        ...
        new Word("πίπτω", "I fall - root *πετ", PRESENT).setRepeatable(true),
        ...
        new Word("μηδείς", "no, no one").setRepeatable(true),
        // 88
        new Word("ἑπτά", "seven, doesn't decline").setRepeatable(true),
        // 87
        new Word("οὔτε", "neither").setRepeatable(true),
        // 86
        new Word("*αρχ", "(middle) to begin (active) to rule, rare ", ROOT),
        new Word("ἄρχομαι", "I begin (active I rule, but rare) - root *αρχ", MIDDLE, PRESENT).setRepeatable(true),
        ...
        new Word("πληρω", "I fill, fulfill - root *πληρο", PRESENT).setRepeatable(true),
        ...
        // 85
        new Word("καιρός", "time (point and period)", MASCULINE).setRepeatable(true),
        new Word("καιροῦ", "time (point and period)", MASCULINE, GENITIVE),
        new Word("προσ + *ευχ", "to pray ", ROOT),
        new Word("προσεύχομαι", "I pray - root προσ + *ευχ", PRESENT, DEPONENT).setRepeatable(true),
        ...
        // 83
        new Word("μήτηρ", "mother", FEMININE).setRepeatable(true),
        new Word("μητρός", "mother", FEMININE, GENITIVE),
        new Word("ὥστε", "so that, in order that, thus").setRepeatable(true),
        // 82
        ...
        new Word("ἕκαστος", "each, every", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἕκαστη", "each, every", ADJECTIVE, FEMININE),
        new Word("ἕκαστον", "each, every", ADJECTIVE, NEUTER),
        new Word("ὅπου", "where, whereas").setRepeatable(true),
        // 81
        ...
        // 80
        new Word("άποστολος", "apostle", MASCULINE).setRepeatable(true),
        new Word("άποστολου", "apostle", MASCULINE, GENITIVE),
        // 79
        new Word("*πεμπ", "to send ", ROOT),
        new Word("πέμπω", "I send - root *πεμπ", PRESENT).setRepeatable(true),
        ...
        new Word("ὑπάγω", "I go away, I draw off - root ὑπο + *αγ", PRESENT).setRepeatable(true),
        ...
        new Word("δίκαιος", "upright, just, righteous", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("δικαία", "upright, just, righteous", ADJECTIVE, FEMININE),
        new Word("δικαιον", "upright, just, righteous", ADJECTIVE, NEUTER),
        // 78
        new Word("στόµα", "mouth", NEUTER).setRepeatable(true),
        new Word("στόματος", "mouth", NEUTER, GENITIVE),
        new Word("πονηρός", "physical: sick, bad spiritual: evil, wicked", ADJECTIVE, MASCULINE).setRepeatable(true),
        ...
        // 77
        new Word("σηµεῖον", "sign, miracle", NEUTER).setRepeatable(true),
        new Word("σηµεῖου", "sign, miracle", NEUTER, GENITIVE),
        new Word("ανα + *οιγω", "to open, unlock, disclose ", ROOT),
        new Word("ἀνοίγω", "I open, unlock, disclose - root ανα + *οιγω", PRESENT).setRepeatable(true),
        ...
        new Word("βαπτίζω", "I baptize, wash, dip - root *βαπτιδ", PRESENT).setRepeatable(true),
        ...
        // 76
        new Word("εὐαγγέλιον", "good news, gospel", NEUTER).setRepeatable(true),
        new Word("εὐαγγέλιου", "good news, gospel", NEUTER, GENITIVE),
        new Word("πρόσωπον", "face, countenance", NEUTER).setRepeatable(true),
        new Word("πρόσωπου", "face, countenance", NEUTER, GENITIVE),
        new Word("ὕδωρ", "water", NEUTER).setRepeatable(true),
        new Word("ὕδατος", "water", NEUTER, GENITIVE),
        new Word("*μαρτυρε", "to bear witness ", ROOT),
        new Word("μαρτυρῶ", "I bear witness - root *μαρτυρε", PRESENT).setRepeatable(true),
        ...
        // 75
        new Word("κεφαλή", "head", FEMININE).setRepeatable(true),
        new Word("κεφαλῆς", "head", FEMININE, GENITIVE),
        new Word("δώδεκα", "twelve").setRepeatable(true),
        // 74
        new Word("απο + *κτεν", "to kill ", ROOT),
        new Word("ἀποκτείνω", "I kill - root απο + *κτεν", PRESENT).setRepeatable(true),
        ...
        new Word("χαίρω", "I rejoice (infinitive used as a greeting) - root *χαρ", PRESENT).setRepeatable(true),
        new Word("ἐχάρην", "I rejoiced - χαίρω root *χαρ", PASSIVE, SECOND_AORIST, DEPONENT),
        // 73
        new Word("φῶς", "light", NEUTER).setRepeatable(true),
        new Word("φωτός", "light", NEUTER, GENITIVE),
        new Word("*πι", "to drink ", ROOT),
        new Word("πίνω", "I drink - root *πι", PRESENT).setRepeatable(true),
        ...
        // 71
        new Word("ἱερόν", "temple", NEUTER).setRepeatable(true),
        new Word("ἱεροῦ", "temple", NEUTER, GENITIVE),
        new Word("πῦρ", "fire", NEUTER).setRepeatable(true),
        new Word("πυρός", "fire", NEUTER, GENITIVE),
        // 70
        new Word("*αἰτε", "to ask ", ROOT),
        new Word("αἰτέω", "I ask - root *αἰτε", PRESENT).setRepeatable(true),
        ...
        new Word("τηρέω", "I keep, I guard - root *τηρε", PRESENT).setRepeatable(true),
        ...
        // 69
        new Word("τρεῖς", "three", MASCULINE, FEMININE).setRepeatable(true),
        new Word("τρία", "three", NEUTER),
        // 68
        new Word("ῥῆμα", "word, thing", NEUTER).setRepeatable(true),
        new Word("ῥῆματος", "word, thing", NEUTER, GENITIVE),
        new Word("σάββατον", "Sabbath, week", NEUTER).setRepeatable(true),
        new Word("σάββατου", "Sabbath, week", NEUTER, GENITIVE),
        // 67
        new Word("ἐντολή", "commandment", FEMININE).setRepeatable(true),
        new Word("ἐντολῆς", "commandment", FEMININE, GENITIVE),
        new Word("πλοῖον", "ship, boat", NEUTER).setRepeatable(true),
        new Word("πλοῖου", "ship, boat", NEUTER, GENITIVE),
        // 66
        new Word("πρεσβύτερος").setRepeatable(true)
        ...
        new Word("φέρω", "I carry, bear, produce - root *φερ", PRESENT).setRepeatable(true),
        ...
        new Word("ἀπολύω", "I release - root απο + *λυ", PRESENT).setRepeatable(true),
        ...
        new Word("καρπός", "fruit, crop, result", MASCULINE).setRepeatable(true),
        new Word("καρποῦ", "fruit, crop, result", MASCULINE, GENITIVE),
        new Word("*φη", "to say ", ROOT),
        new Word("φημί", "I say - root *φη", PRESENT).setRepeatable(true),
        new Word("ἔφη", "I said - φημί root *φη", AORIST),
        // 65
        new Word("εἴτε", "if, whether", PARTICLE).setRepeatable(true),
        // 63
        new Word("ὄρος", "mountain, hill", NEUTER).setRepeatable(true),
        new Word("ὄρους", "mountain, hill", NEUTER, GENITIVE),
        new Word("γραμματεύς", "scribe", MASCULINE).setRepeatable(true),
        new Word("γραμματέως", "scribe", MASCULINE, GENITIVE),
        new Word("δαιμόνιον", "demon", NEUTER).setRepeatable(true),
        new Word("δαιμόνιου", "demon", NEUTER, GENITIVE),
        new Word("*ερωτα", "to ask", ROOT),
        new Word("ἐρωτάω", "I ask - root *ερωτα", PRESENT).setRepeatable(true),
        ...
        new Word("δοκέω", "I think, seem - root *δοκ", PRESENT).setRepeatable(true),
        ...
        new Word("θρόνος", "throne", MASCULINE).setRepeatable(true),
        new Word("θρόνου", "throne", MASCULINE, GENITIVE),
        // 61
        new Word("*δοξαδ", "to praise, honor, glorify ", ROOT),
        new Word("δοξάζω", "I praise, honor, glorify - root *δοξαδ", PRESENT).setRepeatable(true),
        ...
        new Word("κηρύσσω", "I proclaim, preach - root *κηρυγ").setRepeatable(true),
        ...
        new Word("εὐαγγελίζω", "I bring good news , often occurs in middle voice with same meaning - root εὐ + *αγγελιδ", PRESENT).setRepeatable(true),
        ...
        new Word("ὑπάρχω", "I am, I exist - root ὑπό + *αρχ", PRESENT).setRepeatable(true),
        new Word("ἤδη", "now, already").setRepeatable(true),
        new Word("ὧδε", "here").setRepeatable(true),
        new Word("νύξ", "night", FEMININE).setRepeatable(true),
        new Word("νυκτός", "night", FEMININE, GENITIVE),
        // 60
        new Word("ἱμάτιον", "garment", NEUTER).setRepeatable(true),
        new Word("ἱμάτιου", "garment", NEUTER, GENITIVE),
        new Word("*προσκυνε", "to fall down to worship", ROOT),
        new Word("προσκυνέω", "I fall down to worship - root *προσκυνε", PRESENT).setRepeatable(true),
        ...
        new Word("ἀσπάζομαι", "I greet, salute - root *ἀσπαδ", PRESENT, DEPONENT).setRepeatable(true),
        new Word("ἠσπασάμην", "I greeted, saluted - ἀσπάζομαι root *ἀσπαδ", AORIST, DEPONENT),
        new Word("λίθος", "stone", MASCULINE).setRepeatable(true),
        new Word("λίθου", "stone", MASCULINE, GENITIVE),
        new Word("διδάσκαλος", "teacher", MASCULINE).setRepeatable(true),
        new Word("διδάσκαλου", "teacher", MASCULINE, GENITIVE),
        new Word("χαρά", "joy", FEMININE).setRepeatable(true),
        new Word("χαρᾶς", "joy", FEMININE, GENITIVE),
        new Word("συνάγω", "I bring together, I compile ", PRESENT).setRepeatable(true),
        ...
        new Word("θεωρέω", "I look at, behold - root *θεωρε", PRESENT).setRepeatable(true),
        ...
        // 57
        new Word("τοιοῦτος", "such, of such kind", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("τοιαῦτη", "such, of such kind", ADJECTIVE, FEMININE),
        new Word("τοιοῦτον", "such, of such kind", ADJECTIVE, NEUTER),
        // 56
        new Word("μηδέ", "and not, neither").setRepeatable(true),
        new Word("*δεχ", "to take, receive ", ROOT),
        new Word("δέχομαι", "I take, receive ", DEPONENT).setRepeatable(true),
        ...
        new Word("λοιπός").setRepeatable(true)
        ...
        new Word("ἀρχή", "beginning; ruler", FEMININE).setRepeatable(true),
        new Word("ἀρχῆς", "beginning; ruler", FEMININE, GENITIVE),
        // 54
        new Word("δεξιός", "right (hand, side)", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("δεξιά", "right (hand, side)", ADJECTIVE, FEMININE),
        new Word("δεξιόν", "right (hand, side)", ADJECTIVE, NEUTER),
        new Word("μέσος", "middle, in the midst", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("μέση", "middle, in the midst", ADJECTIVE, FEMININE),
        new Word("μέσον", "middle, in the midst", ADJECTIVE, NEUTER),
        new Word("χρόνος", "time", MASCULINE).setRepeatable(true),
        new Word("χρόνου", "time", MASCULINE, GENITIVE),
        new Word("ούχι", "not"),
        // 53
        new Word("ἐλπίς", "hope, expectation", FEMININE).setRepeatable(true),
        new Word("ἐλπίδος", "hope, expectation", FEMININE, GENITIVE),
        new Word("διό", "therefore, for this reason").setRepeatable(true),
        new Word("ὅπως", "so that, in order that, how that").setRepeatable(true),
        // 52
        new Word("ἐπαγγελία", "promise", FEMININE).setRepeatable(true),
        new Word("ἐπαγγελίας", "promise", FEMININE, GENITIVE),
        new Word("παιδίον", "child, infant", NEUTER).setRepeatable(true),
        new Word("παιδίου", "child, infant", NEUTER, GENITIVE),
        new Word("*πειθ", "to persuade ", ROOT),
        new Word("πείθω", "I persuade - root *πειθ", PRESENT).setRepeatable(true),
        ...
        new Word("σπείρω", "I sow - root *σπερ", PRESENT).setRepeatable(true),
        ...
        // 51
        new Word("σοφία", "skill, wisdom", FEMININE).setRepeatable(true),
        new Word("σοφίας", "skill, wisdom", FEMININE, GENITIVE),
        new Word("εὐθύς", "immediately").setRepeatable(true),
        // 50
        new Word("γλῶσσα", "tongue, language", FEMININE).setRepeatable(true),
        new Word("γλῶσσης", "tongue, language", FEMININE, GENITIVE),
        new Word("γραφή", "scripture, writing", FEMININE).setRepeatable(true),
        new Word("γραφῆς", "scripture, writing", FEMININE, GENITIVE),
        new Word("παραβολή", "parable", FEMININE).setRepeatable(true),
        new Word("παραβολῆς", "parable", FEMININE, GENITIVE),
        new Word("ἔσχατος", "last", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("ἔσχατη", "last", ADJECTIVE, FEMININE),
        new Word("ἔσχατον", "last", ADJECTIVE, NEUTER),
        new Word("κακός", "bad, evil", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("κακή", "bad, evil", ADJECTIVE, FEMININE),
        new Word("κακόν", "bad, evil", ADJECTIVE, NEUTER),
        new Word("μακάριος", "blessed, happy", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("μακαρία", "blessed, happy", ADJECTIVE, FEMININE),
        new Word("μακάριον", "blessed, happy", ADJECTIVE, NEUTER),
        new Word("τυφλός", "blind", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("τυφλή", "blind", ADJECTIVE, FEMININE),
        new Word("τυφλόν", "blind", ADJECTIVE, NEUTER),
        // 49
        new Word("ἔτος", "year", NEUTER).setRepeatable(true),
        new Word("ἔτους", "year", NEUTER, GENITIVE),
        new Word("χρεία", "need, necessity", FEMININE).setRepeatable(true),
        new Word("χρείας", "need, necessity", FEMININE, GENITIVE),
        new Word("παραλαμβάνω", "I take to myself, take along, take over", PRESENT).setRepeatable(true),
        ...
        new Word("φανερῶ", "I reveal, make known - root *φανερο", PRESENT).setRepeatable(true),
        ...
        new Word("ἄρα", "then, therefore").setRepeatable(true),
        // 48
        new Word("ἔρημος", "isolated, desolate, deserted, used as substantive, desert (feminine in this case)", ADJECTIVE).setRepeatable(true),
        new Word("ἀποδίδωμι", "I give up, give back, pay", PRESENT).setRepeatable(true),
        ...
        // 47
        new Word("πρό", "before, above").setRepeatable(true),
        new Word("κρίσις", "judgement, legal case", FEMININE).setRepeatable(true),
        new Word("κρίσεως", "judgement, legal case", FEMININE, GENITIVE),
        new Word("φόβος", "fear, fear inspiring thing, reverence", MASCULINE).setRepeatable(true),
        new Word("φόβου", "fear, fear inspiring thing, reverence", MASCULINE, GENITIVE),
        new Word("φυλακή", "guard, prison, watch (of the night)", FEMININE).setRepeatable(true),
        ...
        new Word("κρατῶ", "I grasp, am strong, take possession - κρατέω root *κρατε", PRESENT).setRepeatable(true),
        ...
        new Word("προσφέρω", "I bring, I offer - root προσ + φερω", PRESENT).setRepeatable(true),
        ...
        new Word("οὐκέτι", "no longer").setRepeatable(true),
        // 46
        new Word("θηρίον", "non-human animal, wild animal", NEUTER).setRepeatable(true),
        new Word("θηρίου", "non-human animal, wild animal", NEUTER, GENITIVE),
        new Word("σωτηρία", "salvation, deliverance, preservation", FEMININE).setRepeatable(true),
        new Word("σωτηρίας", "salvation, deliverance, preservation", FEMININE, GENITIVE),
        new Word("καθίζω", "I set, seat, appoint, sit down, settle", PRESENT).setRepeatable(true),
        ...
        new Word("σταυρῶ", "I crucify", PRESENT).setRepeatable(true),
        ...
        new Word("μικρός", "small, little", ADJECTIVE, MASCULINE).setRepeatable(true),
        new Word("μικρά", "small, little", ADJECTIVE, FEMININE),
        new Word("μικρόν", "small, little", ADJECTIVE, NEUTER),
        // 45
        new Word("θλῖψις", "trouble that inflicts distress, oppression, affliction, tribulation", FEMININE).setRepeatable(true),
        new Word("θλῖψεως", "trouble that inflicts distress, oppression, affliction, tribulation", FEMININE, GENITIVE),
        new Word("ναός", "temple, deity's palace", MASCULINE).setRepeatable(true),
        new Word("ναοῦ", "temple, deity's palace", MASCULINE, GENITIVE),
        new Word("ἀπαγγέλλω", "I tell, bring news, report", PRESENT).setRepeatable(true),
        ...
        new Word("διώκω", "I pursue, persecute", PRESENT).setRepeatable(true),
        ...
        new Word("ὅμοιος", "of the same nature, like, similar", ADJECTIVE, MASCULINE).setRepeatable(true),
        ...
        // 44
        new Word("ἐπιγινώσκω", "I understand, recognize", PRESENT).setRepeatable(true),
        ...
        new Word("κατοικῶ", "I dwell, settle, inhabit - κατοικέω", PRESENT).setRepeatable(true),
