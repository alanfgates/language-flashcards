...
class GreekBuilderHelperVocab {
  static List<Word> getVocab() {
    return Arrays.asList(
        ...
        new Word("ἀποκρίνομαι", "I answer - root *αποκριν", PRESENT, DEPONENT),
        ...
        new Word("ἀνοίγω", "I open, unlock, disclose - compound ανα + *οιγω", PRESENT),
        ...
        new Word("λοιπός", "remaining (adj), henceforth (adv)", true, MASCULINE),
        new Word("λοιπή", "remaining (adj), henceforth (adv)", true, FEMININE),
