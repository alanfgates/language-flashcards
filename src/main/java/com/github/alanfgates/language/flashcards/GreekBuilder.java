...
public class GreekBuilder extends BaseLanguageBuilder {
  ...
  public List<GrammarRule> buildRules() {
    return Arrays.asList(
        new GrammarRule("Nouns rules: 1/10\n" +
        ...
        new GrammarRule("Uses of Genitive 5/9\n" +
        ...
        new GrammarRule("Uses of Genitive 6/9\n" +
        ...
        new GrammarRule("Functions of the Adjective 1/3\n" +
        ...
        new GrammarRule("Functions of the Adjective 2/3\n" +
        ...
        new GrammarRule("Determining adjective function: 2/3\n" +
        ...
        new GrammarRule("Determining adjective function: 3/3\n" +
            " * When there is no article context is your only guide."),

        new GrammarRule("Adjective Declensions 1/4\n" +
            "2-1-2:  masculine and neuter in 2nd, feminine in 1st"),

        new GrammarRule("Adjective Declensions 2/4\n" +
            "3-1-3:  masculine and neuter in 3rd, feminine in 1st"),

        new GrammarRule("Adjective Declensions 3/4\n" +
        ...
        new GrammarRule("Adjective Declensions 4/4\n" +
            "3-3:    all in 3rd (masculine and feminine have same endings)"),

        new GrammarRule("Article & a Prepositional Phrase 1/2\n" +
        ...
        new GrammarRule("Article & a Prepositional Phrase 2/2\n" +
            "Articles can proceed prepositional phrases:\n" +
        ...
        new GrammarRule("The Three Uses of αὐτος 1/3\n" +
            " 1. Personal pronoun."),

        new GrammarRule("The Three Uses of αὐτος 2/3\n" +
        ...
        new GrammarRule("The Three Uses of αὐτος 3/3\n" +
        ...
        new GrammarRule("Degrees of an adjective: 1/3\n" +
            " * Positive: uncompared e.g μεγας large"),

        new GrammarRule("Degrees of an adjective: 2/3\n" +
            " * Comparative: greater of two items: e.g. μειζων larger"),

        new GrammarRule("Degrees of an adjective: 3/3\n" +
        ...
        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 1/12\n" +
            " * two like vowels combine to the associated long vowel"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 2/12\n" +
            " * two like vowels combine to the associated long vowel except (1/2)\n" +
            "   * ο + ο = ου"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 3/12\n" +
            " * two like vowels combine to the associated long vowel except (2/2)\n" +
            "   * ε + ε = ει"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 4/12\n" +
            " * (anything but ε) + ο = ω (commutative)"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 5/12\n" +
            " * ε + ο = ου (commutative)"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 6/12\n" +
            " * anything + ω = ω (commutative)"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 7/12\n" +
            " * α + ε/η = α"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 8/12\n" +
            " * ε/η + α  = η"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 9/12\n" +
            " * α + ε + ι = ᾳ"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 10/12\n" +
            " * ε + α + ι = ῃ"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 11/12\n" +
            " * ο + ε + ι = οι"),

        new GrammarRule("Contract verbs are verbs that end in α, ε, or ο.  In the present and\n" +
            "imperfect tenses the final vowel contracts with the connecting vowel as follows: 12/12\n" +
        ...
        new GrammarRule("Verb roots and stems: 2/3\n" +
        ...
        new GrammarRule("Verb roots and stems: 3/3\n" +
        ...
        new GrammarRule("Common verb root modifications: 1/6\n" +
            " * When the present tense stem ends in ιζω or αζω the root generally ends in a\n" +
            "   dental (τ, δ, θ) *βαπτιδ -> βαπτιζω"),

        new GrammarRule("Common verb root modifications: 2/6\n" +
            " * When the present tense stem ends in ασσω the root generally ends in a\n" +
            "   velar ( κ, γ, χ) *ταραχ -> ταρασσω"),

        new GrammarRule("Common verb root modifications: 3/6\n" +
            " * When the present tense stem ends in a double consonant the root often ends in\n" +
            "   a single consonant: *βαλ -> βαλλω"),

        new GrammarRule("Common verb root modifications: 4/6\n" +
            " * Some roots add a iota in the present stem: *αρ -> αἴρω"),

        new GrammarRule("Common verb root modifications: 5/6\n" +
            " * Some roots add σκ or ισκ to form the present: *γνω -> γινωσκω"),

        new GrammarRule("Common verb root modifications: 6/6\n" +
            " * Some stem vowels ablaut."),

        new GrammarRule("Augments for imperfect and aorist: 1/9\n" +
            "* If the word begins with a consonant, an ε is prepended."),

        new GrammarRule("Augments for imperfect and aorist: 2/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  α + ε = η"),

        new GrammarRule("Augments for imperfect and aorist: 3/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  ε + ε = η"),

        new GrammarRule("Augments for imperfect and aorist: 4/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  ο + ε = ω"),

        new GrammarRule("Augments for imperfect and aorist: 5/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  η + ε = η"),

        new GrammarRule("Augments for imperfect and aorist: 6/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  ι + ε = ι"),

        new GrammarRule("Augments for imperfect and aorist: 7/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  υ + ε = υ"),

        new GrammarRule("Augments for imperfect and aorist: 8/9\n" +
            "* If the word begins with a vowel the vowel lengthens:\n" +
            "  ω + ε = ω"),

        new GrammarRule("Augments for imperfect and aorist: 9/9\n" +
        ...
        new GrammarRule("Base stems: 1/6\n" +
            "* Present stem (active, middle, passive)"),

        new GrammarRule("Base stems: 2/6\n" +
            "* Future active stem (also used for middle)"),

        new GrammarRule("Base stems: 3/6\n" +
            "* Aorist active stem (also used for middle)"),

        new GrammarRule("Base stems: 4/6\n" +
            "* Perfect active stem"),

        new GrammarRule("Base stems: 5/6\n" +
            "* Aorist passive stem"),

        new GrammarRule("Base stems: 6/6\n" +
            "* Perfect middle/passive stem\n"),

        new GrammarRule("Tense stems used for other tenses: 1/6\n" +
            "* Imperfect tense built on present tense stem."),

        new GrammarRule("Tense stems used for other tenses: 2/6\n" +
            "* Future passive built on aorist passive stem."),

        new GrammarRule("Tense stems used for other tenses: 3/6\n" +
            "* Present participle built on present tense stem, aorist participle from aorist stem, perfect participle from perfect stem."),

        new GrammarRule("Tense stems used for other tenses: 4/6\n" +
            "* Subjunctive present formed from present stem, aorist from aorist stem, perfect on the perfect stem."),

        new GrammarRule("Tense stems used for other tenses: 5/6\n" +
            "* Infinitive present formed from present stem, aorist from aorist stem, perfect on the perfect stem."),

        new GrammarRule("Tense stems used for other tenses: 6/6\n" +
            "* If verb is deponent in a stem, it will be deponent in other tenses built on that stem."),

        new GrammarRule("In a compound verb the augment comes after the preposition. 1/5"),

        new GrammarRule("In a compound verb the augment comes after the preposition. 2/5\n" +
            "* If the preposition ends in a vowel it does not contract with the augment"),

        new GrammarRule("In a compound verb the augment comes after the preposition. 3/5\n" +
            "* If the preposition ends in a vowel it does not contract with the augment\n" +
            "  * Usually the final vowel of the preposition drops off."),

        new GrammarRule("In a compound verb the augment comes after the preposition. 4/5\n" +
            "* If the preposition ends in a vowel it does not contract with the augment\n" +
            "  * Sometimes it remains but does not contract."),

        new GrammarRule("In a compound verb the augment comes after the preposition. 5/5\n" +
            "* When a compound verb with a preposition that ends in κ augments the κ\n" +
            "  changes to ξ."),

        new GrammarRule("Imperfect can describe: 1/7\n" +
        ...
        new GrammarRule("Imperfect can describe: 2/7\n" +
        ...
        new GrammarRule("Imperfect can describe: 5/7\n" +
        ...
        new GrammarRule("Perfect tense reduplication: 1/8\n" +
            " * If the word starts with a single consonant, that consonant is doubled with\n" +
            "   and ε placed between."),

        new GrammarRule("Perfect tense reduplication: 2/8\n" +
            " * If the word starts with a single consonant, that consonant is doubled with\n" +
            "   and ε placed between.\n" +
            "   * φ goes to π   χ goes to κ    θ goes to τ"),

        new GrammarRule("Perfect tense reduplication: 3/8\n" +
            " * If the word starts with a vowel or dipthong, the vowel is lengthened."),

        new GrammarRule("Perfect tense reduplication: 4/8\n" +
            " * If the word starts with a vowel or dipthong, the vowel is lengthened.\n" +
            "   * Dipthongs often do not change."),

        new GrammarRule("Perfect tense reduplication: 5/8\n" +
        ...
        new GrammarRule("Perfect tense reduplication: 6/8\n" +
            " * Compound verbs reduplicate the verb portion of the word."),

        new GrammarRule("Perfect tense reduplication: 7/8\n" +
            " * Contract verbs lengthen their contract vowel (ending vowel)."),

        new GrammarRule("Perfect tense reduplication: 8/8\n" +
            " * Second perfect has α instead of κα for the tense formative."),

        new GrammarRule("Middle voice: 1/2\n" +
        ...
        new GrammarRule("Middle voice: 2/2\n" +
        ...
        new GrammarRule("Participle declensions: 1/5\n" +
            "* feminine participle always uses 1st declension"),

        new GrammarRule("Participle declensions: 2/5\n" +
            "* active masculine & neuter use 3rd declension"),

        new GrammarRule("Participle declensions: 3/5\n" +
            "* middle/passive present masculine & neuter use 2nd declension"),

        new GrammarRule("Participle declensions: 4/5\n" +
            "* middle aorist masculine & neuter use 2nd declension"),

        new GrammarRule("Participle declensions: 5/5\n" +
            "* aorist passive use 3rd declension"),

        new GrammarRule("Adjectival participles can be: 1/2\n" +
            "* attributive - acting as an adjective"),

        new GrammarRule("Adjectival participles can be: 2/2\n" +
        ...
        new GrammarRule("Uses of the subjunctive: 1/9\n" +
            "* Possibility or probability."),

        new GrammarRule("Uses of the subjunctive: 2/9\n" +
        ...
        new GrammarRule("Uses of the subjunctive: 3/9\n" +
            "* Can also indicate content of the preceeding verb:\n" +
            "  ἐκήρθξαν ἵνα μετανοῶσιν they preached that they should repent"),

        new GrammarRule("Uses of the subjunctive: 4/9\n" +
        ...
        new GrammarRule("Uses of the subjunctive: 5/9\n" +
            "* Conditional statements introduced by ἐάν.  If (protasis) is in subjunctive, then (apodosis) any tense or mood."),

        new GrammarRule("Uses of the subjunctive: 6/9\n" +
            "* Conditional statements introduced by ἐάν.\n" +
        ...
        new GrammarRule("Uses of the subjunctive: 9/9\n" +
        ...
        new GrammarRule("Three ways to ask a question: 3/3\n" +
        ...
        new GrammarRule("Uses of infininitive: 1/4\n" +
        ...
        new GrammarRule("Uses of infininitive: 2/4\n" +
        ...
        new GrammarRule("Forms of negation: 5/5\n" +
        ...
        new GrammarRule("Athematic verb rules 1/5\n" +
        ...
        new GrammarRule("Athematic verb rules 2/5\n" +
            "* 2: they do not ordinarily use a connecting vowel in the present indicative."),

        new GrammarRule("Athematic verb rules 3/5\n" +
        ...
        new GrammarRule("Athematic verb rules 4/5\n" +
            " 4: the stem vowel will often lengthen, shorten, or drop out (e.g. δο to διδωμι)"),

        new GrammarRule("Athematic verb rules 5/5\n" +
            " 5: most use κα as the tense formative in the aorist."),

        new GrammarRule("Exceptions to a verb uses first aorist or second aorist only: 1/2\n" +
            "δίδωμι uses first aorist in indicative and second aorist for other moods"),

        new GrammarRule("Exceptions to a verb uses first aorist or second aorist only: 2/2\n" +
            "ἵστημι uses both, first aorist ἔστησα for transitive and second aorist ἔστην for intransitive."),

        new GrammarRule("Athematic verbs use same endings as thematic verbs in everything but present active indicative. 1/4\n" +
            "stem: διδω\n" +
            "used in: indicative,active,present; subjunctive,present"),

        new GrammarRule("Athematic verbs use same endings as thematic verbs in everything but present active indicative. 2/4\n" +
            "stem: δω\n" +
        ...
        new GrammarRule("Athematic verbs use same endings as thematic verbs in everything but present active indicative. 3/4\n" +
            "stem: διδο\n" +
            "used in: indicative,middle/passive,present; imperative,present; infinitive,present; participle,present"),

        new GrammarRule("Athematic verbs use same endings as thematic verbs in everything but present active indicative. 4/4\n" +
            "stem: δο\n" +
        ...
        new GrammarRule("The function of the article in Greek is not to make something definite\n" +
            "Rather its presence emphasizes identity.  This can be:  1/9\n" +
        ...
        new GrammarRule("The function of the article in Greek is not to make something definite\n" +
            "Rather its presence emphasizes identity.  This can be:  2/9\n" +
        ...
        new GrammarRule("The function of the article in Greek is not to make something definite\n" +
            "Rather its presence emphasizes identity.  This can be:  7/9\n" +
            " * can function as a grammatical marker:  μετά τῶν ἀγγελων _τῶν_ ἁγίων with the holy angels"),

        new GrammarRule("The function of the article in Greek is not to make something definite\n" +
            "Rather its presence emphasizes identity.  This can be:  8/9\n" +
        ...
        new GrammarRule("The function of the article in Greek is not to make something definite\n" +
            "Rather its presence emphasizes identity.  This can be:  9/9\n" +
        ...
        new GrammarRule("Predicate Nominative: 6/9\n" +
            "* Distinguishing subject in predicate nominative:\n" +
            "  In general, the subject is the known entity.  This knownness can be marked in three ways:\n" +
            "  * The subject will be articular:  πνεῦμα ὁ θεός"),

        new GrammarRule("Predicate Nominative: 7/9\n" +
            "* Distinguishing subject in predicate nominative:\n" +
            "  In general, the subject is the known entity.  This knownness can be marked in three ways:\n" +
            "  * The subject will be a proper name."),

        new GrammarRule("Predicate Nominative: 8/9\n" +
            "* Distinguishing subject in predicate nominative:\n" +
            "  In general, the subject is the known entity.  This knownness can be marked in three ways:\n" +
        ...
        new GrammarRule("Predicate Nominative: 9/9\n" +
